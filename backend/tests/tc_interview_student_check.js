 ...
 * @returns {`/student/course/${string}/interview/check`}
 */
const interviewStudentCheckEndpoint = (course_id) => {
    return `/course/${course_id}/interview/check`;
};
...
describe('Interview Student Check Interview', () => {
    ...
    it('Should show students booked interview', (done) => {
        chai.request(BASE_API_URL)
            .get(interviewStudentCheckEndpoint(1))
